;;; day7.el --- day 7 Advent of Code 2020
...
(defconst day7-input "clear maroon bags contain 1 dull lavender bag.
...
(defun bag-name (bag-rule)
  "Get bag name from BAG-RULE."
  (when (string-match "\\(.*\\) bags contain" bag-rule)
    (match-string 1 bag-rule)))
